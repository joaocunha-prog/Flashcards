...
- **Amiloidose cardíaca:** espessamento ventricular desproporcional à pressão arterial, baixa voltagem ao ECG apesar de hipertrofia ao ecocardiograma (achado discordante clássico), síndrome do túnel do carpo bilateral prévia (décadas antes do quadro cardíaco na ATTR).
- **Cardiomiopatia periparto:** IC nova no último mês de gestação até 5 meses pós-parto, sem outra causa identificável.
- **Cardiomiopatia de Takotsubo:** dor torácica e dispneia agudas após estresse emocional/físico intenso, com ECG mimetizando IAM (supra de ST), mas coronárias normais na angiografia.
