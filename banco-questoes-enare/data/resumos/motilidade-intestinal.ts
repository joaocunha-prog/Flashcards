...
**Motilidade intestinal aparece em 4 questões (1,89% do corpus)** — 3 do ENARE 2025 e 1 do ENARE 2026, com foco consistente em **reconhecer o quadro e definir a conduta escalonada** (conservador → neostigmina → descompressão → cirurgia).

- **Pseudo-obstrução colônica aguda em paciente oncológico** (ENARE 2025 Q11) testa o reconhecimento do Ogilvie em cenário de internação e comorbidade favorecedora.
- **Neostigmina na pseudo-obstrução colônica — monitorização** (ENARE 2025 Q36) cobra especificamente o cuidado de segurança (monitorização cardíaca) durante a infusão.
- **Constipação crônica refratária — impactação fecal** (ENARE 2025 Q22, DIFÍCIL) exige investigação estruturada além do manejo sintomático simples.
- **Pseudo-obstrução intestinal em neuropatia autonômica diabética** (ENARE 2026 Q64) amplia o tema para a dismotilidade crônica fora do contexto agudo hospitalar.
...
- ACG Clinical Guideline — Management of Benign Anorectal Disorders e Acute Colonic Pseudo-obstruction.
- Rome IV Diagnostic Criteria — Functional Constipation e Chronic Intestinal Pseudo-obstruction.
- Diretrizes da Sociedade Brasileira de Diabetes — Complicações crônicas (neuropatia autonômica).
