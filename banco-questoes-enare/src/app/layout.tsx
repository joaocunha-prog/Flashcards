...
export const metadata: Metadata = {
  title: 'Banco de Questões ENARE',
  description:
    'Banco de questões e simulados para a prova de ENARE, com análise de incidência e explicações sob demanda.',
};
    ...
    <html lang="pt-BR" suppressHydrationWarning>
      ...
      <body className="min-h-screen">
        ...
        <footer className="mx-auto w-full max-w-7xl px-4 pb-10 pt-4 text-xs text-slate-500 sm:px-6 lg:px-8 dark:text-slate-500">
          Banco de Questões ENARE · comentários escritos pelo Claude
        </footer>
      </body>
    </html>
  );
